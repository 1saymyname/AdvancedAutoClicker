...
frame.Size = UDim2.new(0, 250, 0, 150) -- Yükseklik azaltıldı (buton kaldırıldı)
...
statusLabel.Text = "Auto Clicker Kapalı (F Tuşu)"
...
UserInputService.InputBegan:Connect(function(input, gp)
    if not gp and input.KeyCode == Enum.KeyCode.F then
        ...
        if isClicking then
            statusLabel.Text = "✅ Auto Clicker Aktif (" .. cps .. " CPS) (F Tuşu)"
            startClicking(cps)
        else
            statusLabel.Text = "⛔ Auto Clicker Kapalı (F Tuşu)"
        end
